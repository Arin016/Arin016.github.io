...
tag: "STREAMING"
minutes: 19
excerpt: "A failed export can leave a successful S3 object. Explicit commit/abort semantics, bounded buffering, and failure behavior, verified against real S3."
---

*Engineering article. Author-reviewed; v2.0.0 is released on Maven Central as `io.github.arin016:s3-outputstream:2.0.0`. Links below point at the public repository.*
...
The [lifecycle decision record](https://github.com/Arin016/s3-outputstream/blob/main/docs/decisions/0001-explicit-completion.md) explains the
...
S3 client. A [complete ZIP example](https://github.com/Arin016/s3-outputstream/blob/main/examples/UploadZip.java) includes imports
...
These are breaking API semantics, documented in the [migration guide](https://github.com/Arin016/s3-outputstream/blob/main/docs/migration.md).
...
[measurement protocol](https://github.com/Arin016/s3-outputstream/blob/main/docs/benchmark-protocol.md).
...
replications. The [summary CSV](https://github.com/Arin016/s3-outputstream/blob/main/docs/evidence/success-summary.csv) supplies memory IQRs
...
![Historical 128 MiB unknown-length comparison: median upload time and sampled heap/RSS, with interquartile ranges](https://raw.githubusercontent.com/Arin016/s3-outputstream/main/docs/figures/128m-comparison.png)
...
in the [archived error table](https://github.com/Arin016/s3-outputstream/blob/main/docs/evidence/unsuccessful-runs.csv). Performance summaries
...
supplement, the [benchmark adapter](https://github.com/Arin016/s3-outputstream/blob/main/src/benchmark/java/io/github/arinmallanna/s3outputstream/BenchmarkMain.java)
...
retry-capable option. [Raw-body fault results](https://github.com/Arin016/s3-outputstream/blob/main/docs/evidence/failure-summary.csv),
[buffered-body fault results](https://github.com/Arin016/s3-outputstream/blob/main/docs/evidence/aws-retry-failure-summary.csv)
...
pooled into the raw-body table. [Buffered-retry success data](https://github.com/Arin016/s3-outputstream/blob/main/docs/evidence/aws-retry-success-summary.csv)
...
whether the adapter removed it. [Full report and raw evidence](https://github.com/Arin016/s3-outputstream/blob/main/docs/benchmark-results.md)
...
[Release and dependency evidence](https://github.com/Arin016/s3-outputstream/blob/main/docs/release.md)
...
general speedup. [Post-update results](https://github.com/Arin016/s3-outputstream/blob/main/docs/benchmark-results.md#post-update-transport-checks)
...
For a local trial, follow the [build instructions](https://github.com/Arin016/s3-outputstream/blob/main/README.md#build-test-and-evaluate-locally)
and [benchmark commands](https://github.com/Arin016/s3-outputstream/blob/main/tools/benchmarks/README.md). The
[evidence bundle](https://github.com/Arin016/s3-outputstream/blob/main/docs/evidence/s3-outputstream-local-evidence-20260908.tar.gz) retains
...
Real-S3 conformance was verified on 9 September 2026: the guarded program passed
against AWS S3 for deterministic 0-byte, 1 KiB and 11 MiB objects, verifying exact
length, SHA-256 integrity, object cleanup and multipart cleanup. The
destination-free, commit-bound [receipt](https://github.com/Arin016/s3-outputstream/blob/main/evidence/real-s3/2026-09-09/receipt.json)
records tested source `f635e05`. Bounded protocol conformance, not a performance,
availability or adoption claim.
...
alone cannot provide it. Public release: v2.0.0 is on Maven Central as
`io.github.arin016:s3-outputstream:2.0.0`.
...
with Codex. Author review completed 10 September 2026. This article describes
repository behavior, synthetic local experiments and the bounded real-S3
conformance run above; it does not establish production use or an
internal-system lineage.*
